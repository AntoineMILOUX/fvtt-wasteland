...
export class WastelandActorSheet extends ActorSheet {
  ...
  async getData() {
    ...
    let formData = {
      ...
      percentHealthLetal : duplicate(this.actor.getProgressPercent("santeLetal")),
      percentHealthNonLetal : duplicate(this.actor.getProgressPercent("santeNonLetal")),
      percentPsyche : duplicate(this.actor.getProgressPercent("psyche")),
